...
public class MtgCard {
	...
	private Legalities legalities; // Keys are Magic play formats. Can be 1v1, brawl, commander, duel, frontier, future, legacy, modern, oldschool, pauper, penny, standard, or vintage. Values can be Legal, Restricted, Banned, or Future. ("Future" is used for a revision of the format in which the card will be legal soon. If the format is not listed, it is assumed the card is not legal in that format.)
	...
	private boolean isStarter; // If this card is found in a booster pack. (If false, it is usually omitted.)
	...
	private String uuidV421; // Compatibility uuid for v4.3.0, but will support v4.2.1 to help people transition until v4.4.0.
